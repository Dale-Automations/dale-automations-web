...
const Benefits = () => {
  ...
  const bioTiltRef = useTilt<HTMLDivElement>(4);
  ...
  return (
    <section id="about" className="py-24 bg-muted/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div ref={bioTiltRef} className="tilt-card glass gradient-border rounded-2xl p-8 md:p-10 space-y-5">
        ...
        >
          {steps.map((s, index) => (
            <TiltCard
              key={index}
              className="tilt-card glass gradient-border rounded-2xl p-6 text-center hover:shadow-elegant transition-all duration-500 glow-hover relative"
            >
